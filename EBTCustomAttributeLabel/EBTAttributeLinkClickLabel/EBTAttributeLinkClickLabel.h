...
- (void)attributeLinkLabelText:(NSString *)textString
            withLinksAttribute:(NSDictionary *)attributeDictionary withLinkClickCompleteHandler:(EBTAttributeLinkClickLabelCompleteHandler)linkCompleteHandler withUnderLineTextString:(NSString *)underLineString,...;
